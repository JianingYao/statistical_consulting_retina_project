...
data <- read.delim("/Users/yanzhang/Desktop/JHU/Consulting/Final/Code/Data/data_cleaned.txt")
dat <- data %>% select(IRB, CSF_NFL_OD, CSF_NFL_OS, age, gender, BMI, BUN.Cr, Adiponectin, Insulin, Leptin) %>%
